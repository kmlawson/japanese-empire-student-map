...
- **Manchurian Railways 1942** The lines are traced by comparing station names in [満州支那汽車時間表 1942.7](https://archive.org/details/manshu-shina-kisha-jikanhyo-1942.7) with this [満洲鉄道駅名一覧](https://jikokusouko.pages.dev/manshuekimei.htm) and then drawing the lines over an Openstreet Map layer. Almost all of the lines that were not shut down were traced along current train lines via Openstreet map. Note: Claude Fable 5.1 cross compared and found matches on around 600 stations between the present day and those from the lines in 1942, matching names of stations that were within meters of the line they were on. They still need manual checking over. 

- **Train Tools Manchuria 1942** The time tables come from [満州支那汽車時間表 1942.7](https://archive.org/details/manshu-shina-kisha-jikanhyo-1942.7). The tables were reconstructed by Claude Fable 5.1 over a period of several days. Note: these tables have only been spot checked, and will need further checking and verification. Some incorrect station names were fixed but some mistakes no doubt remain as well as stations that were not fully deciphered.
...
* **[Manchuria, railway lines, 1942](gis/source/manchuria-1942-lines.geojson)** — 594 KB
* **[Manchuria, railway stations, 1942](gis/source/manchuria-1942-stations.geojson)** — 166 KB
