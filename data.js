...
JMAP.TERRITORIES = {
  ...
  e1930: [
    ...
    { id: 'ryukyu', atoms: ['ryukyu'], cat: 'metropole', lvl: 1,
      en: 'Ryūkyū Islands / Okinawa Prefecture', ja: '沖縄県 (Okinawa-ken)', orig: '琉球 (Ruuchuu)',
      zh: '琉球・沖繩縣',
      when: 'Annexed 1879',
    ...
    { id: 'ogasawara', atoms: ['ogasawara'], cat: 'metropole', lvl: 3,
      rule: 'Japanese, part of Tokyo prefecture',
    ...
    { id: 'jehol', atoms: ['jehol'], cat: 'chinese', lvl: 3,
      within: 'china',
      en: 'Rèhé (Jehol)', ja: '熱河 (Nekka)', orig: '熱河省 (Rèhé shěng)',
      zh: '熱河省',
    ...
    // Suiyuan is drawn in two halves because Mengchiang held only the eastern
    // one in 1942. That cut is a fact about 1942 and not about 1930: Suiyuan
    // had been a single province since 1928. Both halves are here, and two
    // atoms of one territory show no boundary between them.
    { id: 'chaharsuiyuan', atoms: ['chahar', 'suiyuan', 'suiyuan_w'], cat: 'chinese', lvl: 3,
      within: 'china',
      en: 'Cháhā’ěr & Suíyuǎn (Chahar & Suiyuan)', ja: '察哈爾・綏遠 (Chaharu, Suien)', orig: '察哈爾・綏遠',
      zh: '察哈爾・綏遠',
    ...
    { id: 'xinjiang', atoms: ['xinjiang'], cat: 'chinese', lvl: 3,
      within: 'china',
      en: 'Xīnjiāng (Sinkiang)', ja: '新疆 (Shinkyō)', orig: 'شىنجاڭ (Shinjang)',
      zh: '新疆',
    ...
    { id: 'princelystates', atoms: ['princely'], cat: 'british', lvl: 3, adminOnly: true,
      en: 'Princely states',             when: 'Rulers in subsidiary alliance with the Crown',
    ...
    // Christmas Island was annexed to the Straits Settlements in 1900 and run
    // from Singapore, twelve hundred miles away, so it belongs with the colony
    // rather than with the Indian Ocean.
    { id: 'malaya', atoms: ['malaya', 'malaya_thai', 'christmas'], cat: 'british', lvl: 2,
    ...
    { id: 'linephoenix', atoms: ['linephoenix'], cat: 'british', lvl: 3,
      rule: 'British colony',
      en: 'The Line & Phoenix Islands',
      when: 'Gilbert & Ellice Islands Colony',
    ...
    { id: 'uspacific', atoms: ['uspacific'], cat: 'american', lvl: 3,
      rule: 'American',
      en: 'Palmyra, Kingman Reef, Howland, Baker, Jarvis & Swains',
      when: 'American; most claimed under the Guano Islands Act',
    ...
    { id: 'nzpacific', atoms: ['nzpacific'], cat: 'british', lvl: 3,
      rule: 'New Zealand administration',
      en: 'Tokelau & the northern Cook Islands',
      when: 'Administered by New Zealand',
    ...
    { id: 'dei', atoms: ['dei'], cat: 'dutch', lvl: 1,
      en: 'Netherlands East Indies', orig: 'Nederlandsch-Indië',
            when: 'Dutch',
    ...
    // Four groups on the far edges of the map, each of them there because who
    // held it was a question. The shapes are traced from the OSM coastlines;
    // at this scale they are smaller than the ring drawn round them.
    { id: 'turtle', atoms: ['turtle', 'mangsee'], cat: 'american', lvl: 3,
      hatch: 'brit',
      rule: 'Administered by British North Borneo, allocated to the Philippines',
      en: 'Turtle & Mangsee Islands', orig: 'Kepulauan Penyu / Mangsee',
    ...
    { id: 'miangas', atoms: ['miangas'], cat: 'dutch', lvl: 3,
      en: 'Miangas (Palmas)', orig: 'Miangas', ja: 'ミアンガス島',
      when: 'Awarded to the Netherlands, 4 April 1928',
    ...
    { id: 'cocos', atoms: ['cocos'], cat: 'british', lvl: 3,
      rule: 'British colony, run from Singapore',
    ...
    { id: 'newguinea_au', atoms: ['newguinea_au'], cat: 'australian', lvl: 3,
      rule: 'Australian territory and mandate',
    ...
    { id: 'nauru_au', atoms: ['nauru_au'], cat: 'australian', lvl: 3,
      rule: 'Mandate — Australia, Britain and New Zealand',
    ...
    { id: 'weihaiwei', atoms: ['weihaiwei'], cat: 'british', c: '#c08a99', lvl: 3,
      en: 'Wēihǎiwèi (Weihaiwei)', ja: '威海衛 (Ikaiei)', orig: '威海衛 (Wēihǎiwèi)',
      zh: '威海衛',
    ...
    { id: 'guangzhouwan', atoms: ['guangzhouwan'], cat: 'french', lvl: 3,
      en: 'Guǎngzhōuwān (Kwangchowan)', ja: '広州湾 (Kōshūwan)', orig: 'Kouang-Tchéou-Wan',
      zh: '廣州灣',
    ...
    // A colour of its own, lighter than the Raj it is not part of and pinker
    // than Bhutan next door, which it was being confused with.
    { id: 'sikkim', atoms: ['sikkim'], cat: 'british', c: '#dcc2ce', lvl: 3,
  ...
  e1942: [
    ...
    // 南滿洲鐡道株式會社資料課 — rather than assembled out of the Chinese
    // provinces the 1930 map is made of. Those stay where they are and go on
    ...
    { id: 'turtle', atoms: ['turtle', 'mangsee'], cat: 'occupied', lvl: 3,
      rule: 'Under Japanese occupation',
      en: 'Turtle & Mangsee Islands', orig: 'Kepulauan Penyu / Mangsee',
      when: 'Taken with British Borneo, January 1942',
    ...
    { id: 'miangas', atoms: ['miangas'], cat: 'occupied', lvl: 3,
      en: 'Miangas (Palmas)', orig: 'Miangas', ja: 'ミアンガス島',
    ...
    { id: 'wake', atoms: ['wake'], cat: 'occupied', lvl: 3,
      rule: 'American territory under Japanese occupation',
    ...
    { id: 'linephoenix', atoms: ['linephoenix'], cat: 'allied', lvl: 3,
      rule: 'British colony',
      en: 'The Line & Phoenix Islands',
      when: 'Never occupied',
    ...
    { id: 'uspacific', atoms: ['uspacific'], cat: 'american', lvl: 3,
      rule: 'American',
      en: 'Palmyra, Kingman Reef, Howland, Baker, Jarvis & Swains',
      when: 'Shelled December 1941; held throughout',
    ...
    { id: 'nzpacific', atoms: ['nzpacific'], cat: 'allied', lvl: 3,
      rule: 'New Zealand administration',
      en: 'Tokelau & the northern Cook Islands',
      when: 'Never occupied',
    ...
    { id: 'nauru_au', atoms: ['nauru_au'], cat: 'occupied', lvl: 3,
      rule: 'Mandate under Japanese occupation',
      en: 'Nauru', ja: 'ナウル', orig: 'Naoero',
      zh: '諾魯',
    ...
    { id: 'newguinea_au', atoms: ['newguinea_au'], cat: 'occupied', lvl: 2,
      rule: 'Australian territory and mandate, part under Japanese occupation',
    ...
    { id: 'solomons_br', atoms: ['solomons_br'], cat: 'occupied', lvl: 2,
      rule: 'British protectorate under Japanese occupation',
    ...
    { id: 'thailand', atoms: ['siam', 'siamgain'], cat: 'cobelligerent', lvl: 2,
      ...
      en: 'Thailand', orig: 'ประเทศไทย (Prathet Thai)',
    ...
    { id: 'nepal', atoms: ['nepal'], cat: 'other', c: '#e2d9c6', lvl: 3,
      ...
      when: 'Independent, in treaty with Britain',
      note: 'Never colonised, and recognised as fully independent by Britain in 1923, though bound to it by treaty and supplying the Gurkha regiments.' },
    { id: 'sikkim', atoms: ['sikkim'], cat: 'allied', c: '#dcc2ce', lvl: 3,
      en: 'Sikkim', orig: 'འབྲས་ལྗོངས (Drenjong)',
      zh: '錫金',
      when: 'British protectorate from 1890',
      note: 'A Himalayan kingdom under British protection, not a part of British India — which is why it is drawn apart from it here.' },
...
JMAP.SITES = [
  ...
  { id: 'mukden', cat: 'city', lvl: 1, lat: 41.80, lon: 123.43, year: 1905,
    en: 'Shěnyáng (Mukden)', ja: '奉天 (Hōten)', orig: '瀋陽 (Shěnyáng)',
    zh: '瀋陽（奉天）',
  ...
  { id: 'changchun', cat: 'city', lvl: 2, lat: 43.88, lon: 125.32, year: 1907,
    en: 'Chángchūn (Hsinking)', ja: '新京 (Shinkyō)', orig: '長春 (Chángchūn)',
    zh: '長春（新京）',
  ...
  { id: 'harbin', cat: 'city', lvl: 2, lat: 45.80, lon: 126.53, year: 1909,
    en: 'Hā’ěrbīn (Harbin)', ja: 'ハルビン (Harubin)', orig: '哈爾濱 (Hā’ěrbīn)',
    zh: '哈爾濱',
  ...
  { id: 'portarthur', cat: 'city', lvl: 1, lat: 38.82, lon: 121.22, year: 1894,
    en: 'Lǚshùn (Port Arthur, Ryojun)', ja: '旅順 (Ryojun)', orig: '旅順 (Lǚshùn)',
    zh: '旅順',
  ...
  { id: 'dairen', cat: 'city', lvl: 2, lat: 38.91, lon: 121.61, year: 1905,
    en: 'Dàlián (Dairen, Dalny)', ja: '大連 (Dairen)', orig: '大連 (Dàlián)',
    zh: '大連',
  ...
  { id: 'chengde', cat: 'city', lvl: 3, lat: 40.98, lon: 117.94, year: 1933,
    en: 'Chéngdé (Chengteh)', ja: '承徳 (Shōtoku)', orig: '承德 (Chéngdé)',
    zh: '承德',
  ...
  { id: 'nomonhan', cat: 'battle', lvl: 3, lat: 47.73, lon: 118.55, year: 1939,
    en: 'Nuòménhǎn (Nomonhan, Khalkhin Gol)', ja: 'ノモンハン事件 (Nomonhan jiken)', orig: 'Халхын гол',
    zh: '諾門罕',
  ...
  { id: 'wanpaoshan', cat: 'battle', lvl: 3, lat: 44.95, lon: 125.40, year: 1931,
    en: 'Wànbǎoshān (Wanpaoshan)', ja: '万宝山事件 (Manpōzan jiken)', orig: '萬寶山 (Wànbǎoshān)',
    zh: '萬寶山',
    date: 'July 1931',
  ...
  { id: 'beijing', cat: 'city', lvl: 1, lat: 39.90, lon: 116.40, year: 1900,
    en: 'Běijīng (Peking / Peiping)', ja: '北京 (Pekin)', orig: '北京 / 北平 (Běijīng / Běipíng)',
    zh: '北京（北平）',
  ...
  { id: 'marcopolo', cat: 'battle', lvl: 2, lat: 39.85, lon: 116.21, year: 1937,
    en: 'Lúgōuqiáo (the Marco Polo Bridge)', ja: '盧溝橋事件 (Rokōkyō jiken)', orig: '盧溝橋 (Lúgōuqiáo)',
    zh: '盧溝橋',
    date: '7 July 1937',
  ...
  { id: 'tianjin', cat: 'city', lvl: 2, lat: 39.13, lon: 117.20, year: 1885,
    en: 'Tiānjīn (Tientsin)', ja: '天津 (Tenshin)', orig: '天津 (Tiānjīn)',
    zh: '天津',
  ...
  { id: 'kalgan', cat: 'city', lvl: 3, lat: 40.81, lon: 114.88, year: 1937,
    en: 'Zhāngjiākǒu (Kalgan, Changchiakou)', ja: '張家口 (Chōkakō)', orig: '張家口 (Zhāngjiākǒu)',
    zh: '張家口',
  ...
  { id: 'jinan', cat: 'city', lvl: 3, lat: 36.67, lon: 116.99, year: 1928,
    en: 'Jǐnán (Tsinan)', ja: '済南事件 (Sainan jiken)', orig: '濟南 (Jǐnán)',
    zh: '濟南',
    date: 'May 1928',
  ...
  { id: 'qingdao', cat: 'city', lvl: 2, lat: 36.07, lon: 120.38, year: 1914,
    en: 'Qīngdǎo (Tsingtao)', ja: '青島 (Seitō)', orig: '青島 (Qīngdǎo)',
    zh: '青島',
  ...
  { id: 'weihai', cat: 'city', lvl: 3, lat: 37.51, lon: 122.12, year: 1895,
    en: 'Wēihǎi (Weihaiwei)', ja: '威海衛 (Ikaiei)', orig: '威海衛 (Wēihǎiwèi)',
    zh: '威海衛',
  ...
  { id: 'nanjing', cat: 'city', lvl: 1, lat: 32.06, lon: 118.80, year: 1927,
    en: 'Nánjīng (Nanking)', ja: '南京 (Nankin)', orig: '南京 (Nánjīng)',
    zh: '南京',
  ...
  { id: 'shanghai', cat: 'city', lvl: 1, lat: 31.23, lon: 121.47, year: 1863,
    en: 'Shànghǎi (Shanghai)', ja: '上海 (Shanhai)', orig: '上海 (Shànghǎi)',
    zh: '上海',
  ...
  { id: 'wuhan', cat: 'city', lvl: 2, lat: 30.58, lon: 114.28, year: 1861,
    en: 'Wǔhàn (Hankow)', ja: '漢口 (Hankō)', orig: '武漢 / 漢口 (Wǔhàn / Hànkǒu)',
    zh: '武漢（漢口）',
  ...
  { id: 'chongqing', cat: 'city', lvl: 2, lat: 29.56, lon: 106.55, year: 1891,
    en: 'Chóngqìng (Chungking)', ja: '重慶 (Jūkei)', orig: '重慶 (Chóngqìng)',
    zh: '重慶',
  ...
  { id: 'yanan', cat: 'city', lvl: 3, lat: 36.60, lon: 109.49, year: 1936,
    en: 'Yán’ān (Yenan)', ja: '延安 (En’an)', orig: '延安 (Yán’ān)',
    zh: '延安',
  ...
  { id: 'xian', cat: 'city', lvl: 3, lat: 34.34, lon: 108.94, year: 1936,
    en: 'Xī’ān (Sian)', ja: '西安事件 (Seian jiken)', orig: '西安 (Xī’ān)',
    zh: '西安',
    date: 'December 1936',
  ...
  { id: 'guangzhou', cat: 'city', lvl: 2, lat: 23.13, lon: 113.26, year: 1842,
    en: 'Guǎngzhōu (Canton)', ja: '広東 (Kanton)', orig: '廣州 (Guǎngzhōu)',
    zh: '廣州',
  ...
  { id: 'xiamen', cat: 'city', lvl: 3, lat: 24.48, lon: 118.09, year: 1842,
    en: 'Xiàmén (Amoy)', ja: '厦門 (Amoi)', orig: '廈門 (Xiàmén)',
    zh: '廈門',
  ...
  { id: 'bangkok', cat: 'city', lvl: 2, lat: 13.75, lon: 100.50, year: 1782,
    en: 'Bangkok', orig: 'กรุงเทพฯ (Krung Thep)',
...
JMAP.BROWSE = [
  { id: 'paoting', lat: 38.87, lon: 115.47,
    en: 'Bǎodìng (Paoting)', ja: '保定 (Hotei)', zh: '保定' },
  { id: 'taiyuan', lat: 37.87, lon: 112.55,
    en: 'Tàiyuán (Taiyuan)', ja: '太原 (Taigen)', zh: '太原' },
  { id: 'kaifeng', lat: 34.8, lon: 114.31,
    en: 'Kāifēng (Kaifeng)', ja: '開封 (Kaihō)', zh: '開封' },
  { id: 'hefei', lat: 31.86, lon: 117.28,
    en: 'Héféi (Hofei)', ja: '合肥 (Gōhi)', zh: '合肥' },
  { id: 'anqing', lat: 30.51, lon: 117.05,
    en: 'Ānqìng (Anking)', ja: '安慶 (Ankei)', zh: '安慶' },
  { id: 'hangzhou', lat: 30.27, lon: 120.16,
    en: 'Hángzhōu (Hangchow)', ja: '杭州 (Kōshū)', zh: '杭州' },
  { id: 'nanchang', lat: 28.68, lon: 115.89,
    en: 'Nánchāng (Nanchang)', ja: '南昌 (Nanshō)', zh: '南昌' },
  { id: 'fuzhou', lat: 26.07, lon: 119.3,
    en: 'Fúzhōu (Foochow)', ja: '福州 (Fukushū)', zh: '福州' },
  { id: 'changsha', lat: 28.23, lon: 112.94,
    en: 'Chángshā (Changsha)', ja: '長沙 (Chōsa)', zh: '長沙' },
  { id: 'guilin', lat: 25.27, lon: 110.29,
    en: 'Guìlín (Kweilin)', ja: '桂林 (Keirin)', zh: '桂林' },
  { id: 'nanning', lat: 22.82, lon: 108.32,
    en: 'Nánníng (Nanning)', ja: '南寧 (Nannei)', zh: '南寧' },
  { id: 'guiyang', lat: 26.65, lon: 106.63,
    en: 'Guìyáng (Kweiyang)', ja: '貴陽 (Kiyō)', zh: '貴陽' },
  { id: 'kunming', lat: 25.04, lon: 102.72,
    en: 'Kūnmíng (Kunming)', ja: '昆明 (Konmei)', zh: '昆明' },
  { id: 'chengdu', lat: 30.66, lon: 104.07,
    en: 'Chéngdū (Chengtu)', ja: '成都 (Seito)', zh: '成都' },
  { id: 'lanzhou', lat: 36.06, lon: 103.83,
    en: 'Lánzhōu (Lanchow)', ja: '蘭州 (Ranshū)', zh: '蘭州' },
  { id: 'xining', lat: 36.62, lon: 101.78,
    en: 'Xīníng (Sining)', ja: '西寧 (Seinei)', zh: '西寧' },
  { id: 'yinchuan', lat: 38.49, lon: 106.23,
    en: 'Yínchuān (Ningsia)', ja: '寧夏 (Neika)', zh: '寧夏（銀川）' },
  { id: 'hohhot', lat: 40.84, lon: 111.75,
    en: 'Hūhéhàotè (Kweisui)', ja: '厚和 (Kōwa)', zh: '歸綏（呼和浩特）' },
  { id: 'baotou', lat: 40.66, lon: 109.84,
    en: 'Bāotóu (Paotow)', ja: '包頭 (Hōtō)', zh: '包頭' },
  { id: 'qiqihar', lat: 47.35, lon: 123.92,
    en: 'Qíqíhā’ěr (Tsitsihar)', ja: 'チチハル (Chichiharu)', zh: '齊齊哈爾' },
  { id: 'jilincity', lat: 43.84, lon: 126.55,
    en: 'Jílín (Kirin)', ja: '吉林 (Kirin)', zh: '吉林' },
  { id: 'mudanjiang', lat: 44.58, lon: 129.6,
    en: 'Mutankiang (Mudanjiang)', ja: '牡丹江 (Botankō)', zh: '牡丹江' },
  { id: 'fushun', lat: 41.88, lon: 123.94,
    en: 'Fǔshùn (Fushun)', ja: '撫順 (Bujun)', zh: '撫順' },
  { id: 'anshan', lat: 41.11, lon: 122.99,
    en: 'Ānshān (Anshan)', ja: '鞍山 (Anzan)', zh: '鞍山' },
  { id: 'jinzhou', lat: 41.1, lon: 121.13,
    en: 'Jǐnzhōu (Chinchow)', ja: '錦州 (Kinshū)', zh: '錦州' },
  { id: 'yingkou', lat: 40.67, lon: 122.24,
    en: 'Yíngkǒu (Newchwang)', ja: '營口 (Eikō)', zh: '營口' },
  { id: 'dandong', lat: 40.13, lon: 124.39,
    en: 'Antung (Dandong)', ja: '安東 (Antō)', zh: '安東' },
  { id: 'urumqi', lat: 43.83, lon: 87.62,
    en: 'Wūlǔmùqí (Urumchi)', ja: '迪化 (Tekika)', zh: '迪化（烏魯木齊）' },
  { id: 'kashgar', lat: 39.47, lon: 75.99,
    en: 'Kāshí (Kashgar)', ja: 'カシュガル (Kashugaru)', zh: '喀什噶爾' },
  { id: 'lhasa', lat: 29.65, lon: 91.14,
    en: 'Lhasa' },
  { id: 'kangding', lat: 30.05, lon: 101.96,
    en: 'Kāngdìng (Kangting)', ja: '康定 (Kōtei)', zh: '康定' },
  { id: 'zhenjiang', lat: 32.19, lon: 119.43,
    en: 'Zhènjiāng (Chinkiang)', ja: '鎮江 (Chinkō)', zh: '鎮江' },
  { id: 'shantou', lat: 23.35, lon: 116.68,
    en: 'Shàntóu (Swatow)', ja: '汕頭 (Santō)', zh: '汕頭' },
  { id: 'ningbo', lat: 29.87, lon: 121.55,
    en: 'Níngbō (Ningpo)', ja: '寧波 (Nēhā)', zh: '寧波' },
  { id: 'wenzhou', lat: 28.0, lon: 120.7,
    en: 'Wēnzhōu (Wenchow)', ja: '温州 (Onshū)', zh: '溫州' },
  { id: 'yantai', lat: 37.46, lon: 121.45,
    en: 'Yāntái (Chefoo)', ja: '芝罘 (Shifu)', zh: '芝罘（煙台）' },
  ...
  { id: 'ulanbator', lat: 47.89, lon: 106.91,
    en: 'Ulan Bator (Urga)', ja: '庫倫 (Kuron)', zh: '庫倫（烏蘭巴托）' },
  ...
  { id: 'koror', lat: 7.34, lon: 134.48,
    en: 'Koror', ja: 'コロール (Korōru)' },
  { id: 'tangshan', lat: 39.63, lon: 118.18,
    en: 'Tángshān (Tangshan)', ja: '唐山 (Tōzan)', zh: '唐山' },
  { id: 'shanhaiguan', lat: 40.01, lon: 119.75,
    en: 'Shānhǎiguān (Shanhaikuan)', ja: '山海関 (Sankaikan)', zh: '山海關' },
  { id: 'datong', lat: 40.09, lon: 113.3,
    en: 'Dàtóng (Tatung)', ja: '大同 (Daidō)', zh: '大同' },
  { id: 'luoyang', lat: 34.62, lon: 112.45,
    en: 'Luòyáng (Loyang)', ja: '洛陽 (Rakuyō)', zh: '洛陽' },
  { id: 'zhengzhou', lat: 34.75, lon: 113.63,
    en: 'Zhèngzhōu (Chengchow)', ja: '鄭州 (Teishū)', zh: '鄭州' },
  { id: 'suzhou', lat: 31.3, lon: 120.62,
    en: 'Sūzhōu (Soochow)', ja: '蘇州 (Soshū)', zh: '蘇州' },
  { id: 'wuxi', lat: 31.57, lon: 120.3,
    en: 'Wúxī (Wusih)', ja: '無錫 (Mushaku)', zh: '無錫' },
  { id: 'xuzhou', lat: 34.26, lon: 117.19,
    en: 'Xúzhōu (Hsuchow)', ja: '徐州 (Joshū)', zh: '徐州' },
  { id: 'wuhu', lat: 31.35, lon: 118.38,
    en: 'Wúhú (Wuhu)', ja: '蕪湖 (Buko)', zh: '蕪湖' },
  { id: 'bengbu', lat: 32.92, lon: 117.39,
    en: 'Bèngbù (Pengpu)', ja: '蚌埠 (Bōfu)', zh: '蚌埠' },
  { id: 'jiujiang', lat: 29.71, lon: 116.0,
    en: 'Jiǔjiāng (Kiukiang)', ja: '九江 (Kyūkō)', zh: '九江' },
  { id: 'yichang', lat: 30.69, lon: 111.29,
    en: 'Yíchāng (Ichang)', ja: '宜昌 (Gishō)', zh: '宜昌' },
  { id: 'hengyang', lat: 26.89, lon: 112.57,
    en: 'Héngyáng (Hengyang)', ja: '衡陽 (Kōyō)', zh: '衡陽' },
  { id: 'yueyang', lat: 29.36, lon: 113.13,
    en: 'Yuèyáng (Yochow)', ja: '岳陽 (Gakuyō)', zh: '岳陽' },
  { id: 'shaoguan', lat: 24.81, lon: 113.6,
    en: 'Sháoguān (Shiuchow)', ja: '韶関 (Shōkan)', zh: '韶關' },
  { id: 'wuzhou', lat: 23.48, lon: 111.28,
    en: 'Wúzhōu (Wuchow)', ja: '梧州 (Goshū)', zh: '梧州' },
  { id: 'zunyi', lat: 27.73, lon: 106.93,
    en: 'Zūnyì (Tsunyi)', ja: '遵義 (Jungi)', zh: '遵義' },
  { id: 'dali', lat: 25.61, lon: 100.27,
    en: 'Dàlǐ (Tali)', ja: '大理 (Dairi)', zh: '大理' },
  { id: 'wanxian', lat: 30.81, lon: 108.41,
    en: 'Wànzhōu (Wanhsien)', ja: '万県 (Manken)', zh: '萬縣' },
  { id: 'baoji', lat: 34.36, lon: 107.14,
    en: 'Bǎojī (Paoki)', ja: '宝鶏 (Hōkei)', zh: '寶雞' },
  { id: 'tianshui', lat: 34.58, lon: 105.72,
    en: 'Tiānshuǐ (Tienshui)', ja: '天水 (Tensui)', zh: '天水' },
  { id: 'chaoyang', lat: 41.57, lon: 120.45,
    en: 'Cháoyáng (Chaoyang)', ja: '朝陽 (Chōyō)', zh: '朝陽' },
  { id: 'yanji', lat: 42.91, lon: 129.51,
    en: 'Yenki (Yanji)', ja: '延吉 (Enkichi)', zh: '延吉' },
  { id: 'jiamusi', lat: 46.81, lon: 130.32,
    en: 'Jiāmùsī (Kiamusze)', ja: '佳木斯 (Kamusu)', zh: '佳木斯' },
  { id: 'yining', lat: 43.91, lon: 81.32,
    en: 'Yīníng (Ining)', ja: '伊寧 (Inei)', zh: '伊寧' },
  { id: 'shigatse', lat: 29.27, lon: 88.88,
    en: 'Shigatse' },
  { id: 'hohhot2', lat: 41.03, lon: 101.05,
    en: 'Éjìnà (Etsina)', ja: '額済納 (Gakusaina)', zh: '額濟納' },
  ...
  { id: 'benares', lat: 25.32, lon: 83.01, en: 'Benares (Varanasi)' },
  { id: 'jaipur', lat: 26.92, lon: 75.79, en: 'Jaipur' },
  ...
  /* The Netherlands Indies, which the map reduced to eight places for the
     largest colony in the region. Japanese names because Japan held all of
     these from 1942; no Chinese, which was never used for them here. */
  { id: 'jogjakarta', lat: -7.80, lon: 110.37, en: 'Jogjakarta (Yogyakarta)', ja: 'ジョクジャカルタ' },
  { id: 'soerakarta', lat: -7.57, lon: 110.83, en: 'Soerakarta (Surakarta, Solo)', ja: 'スラカルタ' },
  { id: 'buitenzorg', lat: -6.60, lon: 106.80, en: 'Buitenzorg (Bogor)', ja: 'ボイテンゾルグ' },
...
JMAP.PROVINCE_EPOCH = {
  ...
  e1942: {
    ...
    'Christmas Island': { en: 'Christmas Island — taken by Japan on 31 March 1942 for its phosphate', ja: 'クリスマス島 (Kurisumasu-tō)' },
  },
};

/* Which cluster a sub-unit belongs to, where that changed between the two
   dates. The cluster is written into the SVG, and the SVG serves both.
   The Dindings — Lumut, Sitiawan and Pangkor — were a Straits Settlement from
   1826 and were retroceded to Perak on 16 February 1935, so on the December
   1942 map they are part of Perak: hovering them should not light Singapore,
   Penang and Malacca, and hovering Singapore should not light them. The key is
   the atom and the sub-unit's own name; the value is the cluster it belongs to
   on that date, or null for none. */
JMAP.CLUSTER_EPOCH = {
  e1942: {
...
JMAP.PROVINCES = {
  ...
  /* The base areas of 1941-42, grouped into the regions the atlas sheet
     labels. The grouping is by where a shape lies and is not a boundary:
     these areas moved from month to month, and a patch near an edge may
     well be filed under its neighbour. */
  ...
  /* the five blocks the occupied zone is drawn from. They are places rather
  ...
  'Amoy and Kinmen': {
    ...
    ja: '厦門 (Amoi)', zh: '廈門・金門' },
  'Swatow and Chaochow': {
    en: 'Shàntóu (Swatow) and Cháozhōu (Chaochow), taken June 1939', ja: '汕頭 (Suatō)', zh: '汕頭・潮州' },
  ...
  'Christmas Island': { en: 'Christmas Island — annexed 1900, a Straits Settlement from 1900 and run from Singapore, worked for phosphate', ja: 'クリスマス島 (Kurisumasu-tō)' },
  ...
  'CentralProvinces': { en: 'Central Provinces — Berar and Nagpur are drawn with Bombay, the Central India states with this' },
