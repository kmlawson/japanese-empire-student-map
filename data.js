...
JMAP.TERRITORIES = {
  ...
  e1930: [
    ...
    { id: 'polynesia', atoms: ['polynesia'], cat: 'other', lvl: 3, unseen: true,
      en: 'Fiji and the Polynesian islands (not shown)',
      when: 'Beyond the edge of this map',
      note: 'Fiji, Samoa, Tonga, the Cooks, the Societies and the rest of Polynesia lie east and south of this frame. Japan reached none of them: the furthest the advance came was the Gilberts, with the landings on Guadalcanal and in Papua the southern limit. The Allied build-up that turned the war ran through these islands — Fiji, Samoa and New Caledonia were garrisoned by American troops from 1942 and were the base for the Solomons campaign.' },
