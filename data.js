...
JMAP.SITES = [
  ...
  { id: 'mukden', cat: 'city', lvl: 1, lat: 41.80, lon: 123.43, year: 1905,
    en: 'Shenyang (Mukden)', ja: '奉天 (Hōten)', orig: '瀋陽 (Shěnyáng)',
    zh: '瀋陽（奉天）',
  ...
  { id: 'changchun', cat: 'city', lvl: 2, lat: 43.88, lon: 125.32, year: 1907,
    en: 'Changchun (Hsinking)', ja: '新京 (Shinkyō)', orig: '長春 (Chángchūn)',
    zh: '長春（新京）',
  ...
  { id: 'portarthur', cat: 'city', lvl: 1, lat: 38.82, lon: 121.22, year: 1894,
    en: 'Lüshun (Port Arthur, Ryojun)', ja: '旅順 (Ryojun)', orig: '旅順 (Lǚshùn)',
    zh: '旅順',
  ...
  { id: 'dairen', cat: 'city', lvl: 2, lat: 38.91, lon: 121.61, year: 1905,
    en: 'Dalian (Dairen, Dalny)', ja: '大連 (Dairen)', orig: '大連 (Dàlián)',
    zh: '大連',
  ...
  { id: 'chengde', cat: 'city', lvl: 3, lat: 40.98, lon: 117.94, year: 1933,
    en: 'Chengde (Chengteh)', ja: '承徳 (Shōtoku)', orig: '承德 (Chéngdé)',
    zh: '承德',
  ...
  { id: 'beijing', cat: 'city', lvl: 1, lat: 39.90, lon: 116.40, year: 1900,
    en: 'Beijing (Peking / Peiping)', ja: '北京 (Pekin)', orig: '北京 / 北平 (Běijīng / Běipíng)',
    zh: '北京（北平）',
  ...
  { id: 'tianjin', cat: 'city', lvl: 2, lat: 39.13, lon: 117.20, year: 1885,
    en: 'Tianjin (Tientsin)', ja: '天津 (Tenshin)', orig: '天津 (Tiānjīn)',
    zh: '天津',
  ...
  { id: 'kalgan', cat: 'city', lvl: 3, lat: 40.81, lon: 114.88, year: 1937,
    en: 'Zhangjiakou (Kalgan, Changchiakou)', ja: '張家口 (Chōkakō)', orig: '張家口 (Zhāngjiākǒu)',
    zh: '張家口',
  ...
  { id: 'jinan', cat: 'city', lvl: 3, lat: 36.67, lon: 116.99, year: 1928,
    en: 'Jinan (Tsinan)', ja: '済南事件 (Sainan jiken)', orig: '濟南 (Jǐnán)',
    zh: '濟南',
    date: 'May 1928',
  ...
  { id: 'qingdao', cat: 'city', lvl: 2, lat: 36.07, lon: 120.38, year: 1914,
    en: 'Qingdao (Tsingtao)', ja: '青島 (Seitō)', orig: '青島 (Qīngdǎo)',
    zh: '青島',
  ...
  { id: 'weihai', cat: 'city', lvl: 3, lat: 37.51, lon: 122.12, year: 1895,
    en: 'Weihai (Weihaiwei)', ja: '威海衛 (Ikaiei)', orig: '威海衛 (Wēihǎiwèi)',
    zh: '威海衛',
  ...
  { id: 'nanjing', cat: 'city', lvl: 1, lat: 32.06, lon: 118.80, year: 1927,
    en: 'Nanjing (Nanking)', ja: '南京 (Nankin)', orig: '南京 (Nánjīng)',
    zh: '南京',
  ...
  { id: 'wuhan', cat: 'city', lvl: 2, lat: 30.58, lon: 114.28, year: 1861,
    en: 'Wuhan (Hankow)', ja: '漢口 (Hankō)', orig: '武漢 / 漢口 (Wǔhàn / Hànkǒu)',
    zh: '武漢（漢口）',
  ...
  { id: 'chongqing', cat: 'city', lvl: 2, lat: 29.56, lon: 106.55, year: 1891,
    en: 'Chongqing (Chungking)', ja: '重慶 (Jūkei)', orig: '重慶 (Chóngqìng)',
    zh: '重慶',
  ...
  { id: 'yanan', cat: 'city', lvl: 3, lat: 36.60, lon: 109.49, year: 1936,
    en: 'Yan’an (Yenan)', ja: '延安 (En’an)', orig: '延安 (Yán’ān)',
    zh: '延安',
  ...
  { id: 'xian', cat: 'city', lvl: 3, lat: 34.34, lon: 108.94, year: 1936,
    en: 'Xi’an (Sian)', ja: '西安事件 (Seian jiken)', orig: '西安 (Xī’ān)',
    zh: '西安',
    date: 'December 1936',
  ...
  { id: 'guangzhou', cat: 'city', lvl: 2, lat: 23.13, lon: 113.26, year: 1842,
    en: 'Guangzhou (Canton)', ja: '広東 (Kanton)', orig: '廣州 (Guǎngzhōu)',
    zh: '廣州',
  ...
  { id: 'xiamen', cat: 'city', lvl: 3, lat: 24.48, lon: 118.09, year: 1842,
    en: 'Xiamen (Amoy)', ja: '厦門 (Amoi)', orig: '廈門 (Xiàmén)',
    zh: '廈門',
...
JMAP.BROWSE = [
  { id: 'paoting', lat: 38.87, lon: 115.47,
    en: 'Baoding (Paoting)', ja: '保定 (Hotei)', zh: '保定' },
  ...
  { id: 'kangding', lat: 30.05, lon: 101.96,
    en: 'Kangding (Kangting)', ja: '康定 (Kōtei)', zh: '康定' },
  { id: 'zhenjiang', lat: 32.19, lon: 119.43,
    en: 'Zhenjiang (Chinkiang)', ja: '鎮江 (Chinkō)', zh: '鎮江' },
  { id: 'shantou', lat: 23.35, lon: 116.68,
    en: 'Shantou (Swatow)', ja: '汕頭 (Santō)', zh: '汕頭' },
  { id: 'ningbo', lat: 29.87, lon: 121.55,
    en: 'Ningbo (Ningpo)', ja: '寧波 (Nēhā)', zh: '寧波' },
  { id: 'wenzhou', lat: 28.0, lon: 120.7,
    en: 'Wenzhou (Wenchow)', ja: '温州 (Onshū)', zh: '溫州' },
  { id: 'yantai', lat: 37.46, lon: 121.45,
    en: 'Yantai (Chefoo)', ja: '芝罘 (Shifu)', zh: '芝罘（煙台）' },
  ...
  { id: 'shanhaiguan', lat: 40.01, lon: 119.75,
    en: 'Shanhaiguan (Shanhaikuan)', ja: '山海関 (Sankaikan)', zh: '山海關' },
  { id: 'datong', lat: 40.09, lon: 113.3,
    en: 'Datong (Tatung)', ja: '大同 (Daidō)', zh: '大同' },
  { id: 'luoyang', lat: 34.62, lon: 112.45,
    en: 'Luoyang (Loyang)', ja: '洛陽 (Rakuyō)', zh: '洛陽' },
  { id: 'zhengzhou', lat: 34.75, lon: 113.63,
    en: 'Zhengzhou (Chengchow)', ja: '鄭州 (Teishū)', zh: '鄭州' },
  { id: 'suzhou', lat: 31.3, lon: 120.62,
    en: 'Suzhou (Soochow)', ja: '蘇州 (Soshū)', zh: '蘇州' },
  { id: 'wuxi', lat: 31.57, lon: 120.3,
    en: 'Wuxi (Wusih)', ja: '無錫 (Mushaku)', zh: '無錫' },
  { id: 'xuzhou', lat: 34.26, lon: 117.19,
    en: 'Xuzhou (Hsuchow)', ja: '徐州 (Joshū)', zh: '徐州' },
  { id: 'wuhu', lat: 31.35, lon: 118.38,
    en: 'Wuhu', ja: '蕪湖 (Buko)', zh: '蕪湖' },
  { id: 'bengbu', lat: 32.92, lon: 117.39,
    en: 'Bengbu (Pengpu)', ja: '蚌埠 (Bōfu)', zh: '蚌埠' },
  { id: 'jiujiang', lat: 29.71, lon: 116.0,
    en: 'Jiujiang (Kiukiang)', ja: '九江 (Kyūkō)', zh: '九江' },
  { id: 'yichang', lat: 30.69, lon: 111.29,
    en: 'Yichang (Ichang)', ja: '宜昌 (Gishō)', zh: '宜昌' },
  { id: 'hengyang', lat: 26.89, lon: 112.57,
    en: 'Hengyang', ja: '衡陽 (Kōyō)', zh: '衡陽' },
  { id: 'yueyang', lat: 29.36, lon: 113.13,
    en: 'Yueyang (Yochow)', ja: '岳陽 (Gakuyō)', zh: '岳陽' },
  { id: 'shaoguan', lat: 24.81, lon: 113.6,
    en: 'Shaoguan (Shiuchow)', ja: '韶関 (Shōkan)', zh: '韶關' },
  { id: 'wuzhou', lat: 23.48, lon: 111.28,
    en: 'Wuzhou (Wuchow)', ja: '梧州 (Goshū)', zh: '梧州' },
  { id: 'zunyi', lat: 27.73, lon: 106.93,
    en: 'Zunyi (Tsunyi)', ja: '遵義 (Jungi)', zh: '遵義' },
  { id: 'dali', lat: 25.61, lon: 100.27,
    en: 'Dali (Tali)', ja: '大理 (Dairi)', zh: '大理' },
  { id: 'wanxian', lat: 30.81, lon: 108.41,
    en: 'Wanzhou (Wanhsien)', ja: '万県 (Manken)', zh: '萬縣' },
  { id: 'baoji', lat: 34.36, lon: 107.14,
    en: 'Baoji (Paoki)', ja: '宝鶏 (Hōkei)', zh: '寶雞' },
  { id: 'tianshui', lat: 34.58, lon: 105.72,
    en: 'Tianshui (Tienshui)', ja: '天水 (Tensui)', zh: '天水' },
  ...
  { id: 'yining', lat: 43.91, lon: 81.32,
    en: 'Yining (Ining)', ja: '伊寧 (Inei)', zh: '伊寧' },
  { id: 'shigatse', lat: 29.27, lon: 88.88,
    en: 'Shigatse' },
  { id: 'hohhot2', lat: 41.03, lon: 101.05,
    en: 'Ejina (Etsina)', ja: '額済納 (Gakusaina)', zh: '額濟納' },
...
JMAP.PROVINCES = {
  ...
  'Anhui': { en: 'Anhwei (Anhui)' },
  'Chahaer': { en: 'Chahar' },
  'Fujian': { en: 'Fukien (Fujian)' },
  'Gansu': { en: 'Kansu (Gansu)' },
  'Guangdong': { en: 'Kwangtung (Guangdong)' },
  'Guangxi': { en: 'Kwangsi (Guangxi)' },
  'Guizhou': { en: 'Kweichow (Guizhou)' },
  'Hebei': { en: 'Hopei (Hebei)' },
  'Heilongjiang': { en: 'Heilungkiang, called Lungkiang under Manchukuo' },
  'Henan': { en: 'Honan (Henan)' },
  'Hubei': { en: 'Hupeh (Hubei)' },
  'Hunan': { en: 'Hunan' },
  'Jehol': { en: 'Jehol (Rehe)' },
  'Jiangsu': { en: 'Kiangsu (Jiangsu)' },
  'Jiangxi': { en: 'Kiangsi (Jiangxi)' },
  'Jilin': { en: 'Kirin (Jilin)' },
  'Liaoning': { en: 'Liaoning, called Fengtien again under Manchukuo' },
  'Ningxia': { en: 'Ninghsia (Ningxia)' },
  'Qinghai': { en: 'Tsinghai (Qinghai)' },
  'Shaanxi': { en: 'Shensi (Shaanxi)' },
  'Shandong': { en: 'Shantung (Shandong)' },
  'Shanxi': { en: 'Shansi (Shanxi)' },
  'Sichuan': { en: 'Szechwan (Sichuan)' },
  'Suiyuan': { en: 'Suiyuan — the eastern half, which Mengchiang held' },
  'SuiyuanWest': { en: 'Western Suiyuan — Wuyuan, Linhe and the Ordos, held by Fu Tso-yi throughout' },
  'Xikang': { en: 'Sikang — a special administrative region until 1939, then a province' },
  'Xinjiang': { en: 'Sinkiang (Xinjiang)' },
  'Xizang': { en: 'Tibet (Xizang)' },
  'Yunnan': { en: 'Yunnan' },
  'Zhejiang': { en: 'Chekiang (Zhejiang)' },
