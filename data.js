...
JMAP.TERRITORIES = {
  ...
  e1930: [
    ...
    { id: 'tuva', atoms: ['tuva'], cat: 'soviet', lvl: 3,
  ...
  e1942: [
    ...
    { id: 'tuva', atoms: ['tuva'], cat: 'neutral', lvl: 3,
      en: 'Tannu Tuva (Tuvan People’s Republic)', ja: 'トゥヴァ人民共和国', orig: 'Тыва Арат Республик',
      zh: '唐努圖瓦', ko: '투바 인민공화국',
      when: 'Independent in name from 1921',
      note: 'Qing territory until 1911, then a Russian protectorate, then a nominally independent republic from 1921 — recognised only by the Soviet Union and Mongolia. Absorbed into the USSR in 1944. China went on claiming it.' },
...
JMAP.PROVINCES = {
  ...
  'Liaoning': { en: 'Liaoning (Fengtien)', ja: '遼寧 (Ryōnei)', zh: '遼寧（奉天）', ko: '요녕 (Yonyŏng)' },
  ...
  'Xikang': { en: 'Sikang (Xikang)', ja: '西康 (Seikō)', zh: '西康', ko: '서강 (Sŏgang)' },
  ...
  'Keiki': { en: 'Keiki-dō (Kyŏnggi)', ja: '京畿道 (Keiki-dō)', zh: '京畿道', ko: '경기도 (Kyŏnggi-do)' },
  'Kogen': { en: 'Kōgen-dō (Kangwŏn)', ja: '江原道 (Kōgen-dō)', zh: '江原道', ko: '강원도 (Kangwŏn-do)' },
  'Chuseihoku': { en: 'Chūseihoku-dō (North Ch’ungch’ŏng)', ja: '忠清北道 (Chūseihoku-dō)', zh: '忠清北道', ko: '충청북도 (Ch’ungch’ŏngbuk-to)' },
  'Chuseinan': { en: 'Chūseinan-dō (South Ch’ungch’ŏng)', ja: '忠清南道 (Chūseinan-dō)', zh: '忠清南道', ko: '충청남도 (Ch’ungch’ŏngnam-do)' },
  'Zenrahoku': { en: 'Zenrahoku-dō (North Chŏlla)', ja: '全羅北道 (Zenrahoku-dō)', zh: '全羅北道', ko: '전라북도 (Chŏllabuk-to)' },
  'Zenranan': { en: 'Zenranan-dō (South Chŏlla)', ja: '全羅南道 (Zenranan-dō)', zh: '全羅南道', ko: '전라남도 (Chŏllanam-do)' },
  'Keishohoku': { en: 'Keishōhoku-dō (North Kyŏngsang)', ja: '慶尚北道 (Keishōhoku-dō)', zh: '慶尚北道', ko: '경상북도 (Kyŏngsangbuk-to)' },
  'Keishonan': { en: 'Keishōnan-dō (South Kyŏngsang)', ja: '慶尚南道 (Keishōnan-dō)', zh: '慶尚南道', ko: '경상남도 (Kyŏngsangnam-do)' },
  'Kokai': { en: 'Kōkai-dō (Hwanghae)', ja: '黄海道 (Kōkai-dō)', zh: '黃海道', ko: '황해도 (Hwanghae-do)' },
  'Heianhoku': { en: 'Heianhoku-dō (North P’yŏngan)', ja: '平安北道 (Heianhoku-dō)', zh: '平安北道', ko: '평안북도 (P’yŏnganbuk-to)' },
  'Heiannan': { en: 'Heiannan-dō (South P’yŏngan)', ja: '平安南道 (Heiannan-dō)', zh: '平安南道', ko: '평안남도 (P’yŏngannam-do)' },
  'Kankyohoku': { en: 'Kankyōhoku-dō (North Hamgyŏng)', ja: '咸鏡北道 (Kankyōhoku-dō)', zh: '咸鏡北道', ko: '함경북도 (Hamgyŏngbuk-to)' },
  'Kankyonan': { en: 'Kankyōnan-dō (South Hamgyŏng)', ja: '咸鏡南道 (Kankyōnan-dō)', zh: '咸鏡南道', ko: '함경남도 (Hamgyŏngnam-do)' },
