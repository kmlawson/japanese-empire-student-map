...
JMAP.CATEGORIES = {
  ...
  e1942: [
    ...
    { id: 'cededthai', c: '#f8ebc4', en: 'Ceded to Thailand, 1941', ja: '泰国への割譲地', orig: 'Ceded to Thailand', zh: '割讓予泰國', ko: '태국에 할양' },
...
JMAP.TERRITORIES = {
  ...
  e1942: [
    ...
    { id: 'cededthai', atoms: ['siamgain'], cat: 'cededthai', lvl: 3,
...
JMAP.BROWSE = [
  ...
  { id: 'taegu', lat: 35.87, lon: 128.6,
    en: 'Taikyu (Taegu)', ja: '大邱 (Taikyū)', zh: '大邱', ko: '대구 (Taegu)' },
  { id: 'kwangju', lat: 35.16, lon: 126.85,
    en: 'Koshu (Kwangju)', ja: '光州 (Kōshū)', zh: '光州', ko: '광주 (Kwangju)' },
  ...
  { id: 'hamhung', lat: 39.92, lon: 127.54,
    en: 'Kanko (Hamhung)', ja: '咸興 (Kankō)', zh: '咸興', ko: '함흥 (Hamhŭng)' },
  { id: 'sinuiju', lat: 40.1, lon: 124.39,
    en: 'Shingishu (Sinuiju)', ja: '新義州 (Shingishū)', zh: '新義州', ko: '신의주 (Sinŭiju)' },
  { id: 'kaesong', lat: 37.97, lon: 126.55,
    en: 'Kaijo (Kaesong)', ja: '開城 (Kaijō)', zh: '開城', ko: '개성 (Kaesŏng)' },
  ...
  { id: 'taichung', lat: 24.15, lon: 120.67,
    en: 'Taichu (Taichung)', ja: '臺中 (Taichū)', zh: '臺中', ko: '대중 (Taejung)' },
  { id: 'keelung', lat: 25.13, lon: 121.74,
    en: 'Kirun (Keelung)', ja: '基隆 (Kīrun)', zh: '基隆', ko: '기륭 (Kiryung)' },
  { id: 'hualien', lat: 23.98, lon: 121.6,
    en: 'Karenko (Hualien)', ja: '花蓮港 (Karenkō)', zh: '花蓮港', ko: '화련항 (Hwaryŏnhang)' },
  ...
  { id: 'makung', lat: 23.57, lon: 119.57,
    en: 'Mako (Makung), Pescadores', ja: '馬公 (Makō)', zh: '馬公（澎湖）', ko: '마공 (Magong)' },
