...
JMAP.PROVINCES = {
  ...
  'Shaan-Gan-Ning': { en: 'Shaan-Gan-Ning border region — Yenan', zh: '陝甘寧邊區' },
  'Jin-Sui': { en: 'Jin-Sui — Shansi and Suiyuan', zh: '晉綏' },
  'Jin-Cha-Ji': { en: 'Jin-Cha-Ji — Shansi, Chahar and Hopei', zh: '晉察冀' },
  'Jinan': { en: 'Chi-nan — southern Hopei', zh: '冀南' },
  'Taihang and Taiyue': { en: 'Taihang and Taiyue', zh: '太行・太岳' },
  'Ji-Lu-Yu': { en: 'Chi-Lu-Yü — Hopei, Shantung and Honan', zh: '冀魯豫' },
  'Qinghe': { en: 'Ch’ing-ho — the Yellow River delta', zh: '清河' },
  'Jiaodong': { en: 'Chiao-tung — the Shantung peninsula', zh: '膠東' },
  'Luzhong': { en: 'Lu-chung — central Shantung', zh: '魯中' },
  'Lunan and Binhai': { en: 'Lu-nan and Pin-hai — southern and coastal Shantung', zh: '魯南・濱海' },
  'Subei': { en: 'Su-pei — northern Kiangsu', zh: '蘇北' },
  'Huaibei': { en: 'Huai-pei — north of the Huai', zh: '淮北' },
  'Huainan': { en: 'Huai-nan — south of the Huai', zh: '淮南' },
  'Suzhong': { en: 'Su-chung — central Kiangsu', zh: '蘇中' },
  'Sunan': { en: 'Su-nan — southern Kiangsu', zh: '蘇南' },
  'Wanjiang': { en: 'Wan-chiang — the Anhwei Yangtze', zh: '皖江' },
  'Zhedong': { en: 'Che-tung — eastern Chekiang', zh: '浙東' },
  'E-Yu-Wan': { en: 'O-Yü-Wan — Hupeh, Honan and Anhwei', zh: '鄂豫皖' },
  ...
  'Labuan': { en: 'Labuan — a Straits Settlement until 1946, not company territory' },
  'Brunei': { en: 'Brunei' },
  ...
  'Christmas Island': { en: 'Christmas Island — Straits Settlement, annexed 1900 and worked for phosphate', ja: 'クリスマス島 (Kurisumasu-tō)' },
