...
JMAP.TERRITORIES = {
  ...
  e1930: [
    ...
    { id: 'china', atoms: ['china', 'occupiedchina', 'canton', 'hainan'], cat: 'chinese', lvl: 1,
    ...
    { id: 'other', atoms: ['other'], cat: 'other', lvl: 3,
      en: 'Afghanistan, Nepal, Bhutan and Sikkim', ja: 'アフガニスタン・ネパール・ブータン', orig: 'Afghanistan, Nepal, Bhutan',
  ...
  e1942: [
    ...
    { id: 'nanjinggov', atoms: ['occupiedchina', 'canton', 'hainan'], cat: 'puppet', lvl: 1, hatch: true,
      ...
      note: 'Governed on paper by Wang Ching-wei’s collaborationist government at Nanking, with the far south under military administration instead. The boundary drawn here is deliberately coarse: Japanese control ran along the railway lines and around the cities, and Communist and Nationalist guerrillas held much of the countryside inside it. Besides the northern and central bloc it takes in Canton and the Pearl River delta, held from October 1938, and Hainan, taken in February 1939.' },
