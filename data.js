...
JMAP.TERRITORIES = {
  ...
  e1930: [
    ...
    { id: 'wake', atoms: ['wake'], cat: 'american', lvl: 3,
      en: 'Wake Island', orig: 'Wake',
      when: 'American from 1899',
  ...
  e1942: [
    ...
    { id: 'wake', atoms: ['wake'], cat: 'occupied', lvl: 3,
      en: 'Wake Island', ja: 'ウェーク島・大鳥島 (Ōtorishima)', orig: 'Wake',
      when: 'Taken 23 December 1941',
