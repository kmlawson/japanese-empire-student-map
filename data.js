...
JMAP.TERRITORIES = {
  ...
  e1942: [
    ...
    { id: 'guadalcanal', atoms: ['solomons_gc'], cat: 'allied', lvl: 2, hatch: 'occupied',
      ...
      note: 'In December 1942 the island was divided: the Americans held the airfield and the perimeter around it, the Japanese the ground to the west, and neither could dislodge the other. The stripes show it held by both. Japan evacuated in the first week of February 1943, and the campaign is usually taken as the point at which the initiative changed hands.' },
    ...
    { id: 'solomons_allied', atoms: ['solomons_al'], cat: 'allied', lvl: 3,
      ...
      when: 'Allied throughout',
      note: 'The south-eastern islands of the protectorate were never taken. The naval battle of Rennell Island was fought off the last of them in January 1943.' },
    ...
    { id: 'aleutians', atoms: ['aleutians'], cat: 'allied', lvl: 3,
      en: 'Aleutian Islands', ja: 'アリューシャン列島', orig: 'Unangam Tanangin',
      zh: '阿留申群島', ko: '알류샨 열도 (Allyusyan Yŏldo)',
