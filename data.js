...
JMAP.PROVINCES = {
  ...
  'Johor': { en: 'Johore', ja: 'ジョホール (Johōru)', zh: '柔佛', ko: '조호르' },
  'Pahang': { en: 'Pahang', ja: 'パハン (Pahan)', zh: '彭亨', ko: '파항' },
  'Perak': { en: 'Perak', ja: 'ペラ (Pera)', zh: '霹靂', ko: '페락' },
  'Selangor': { en: 'Selangor', ja: 'スランゴール (Surangōru)', zh: '雪蘭莪', ko: '슬랑오르' },
  'NegeriSembilan': { en: 'Negri Sembilan', ja: 'ヌグリスンビラン', zh: '森美蘭', ko: '느그리슴빌란' },
  'Malacca': { en: 'Malacca', ja: 'マラッカ (Marakka)', zh: '馬六甲', ko: '말라카' },
  'Penang': { en: 'Penang', ja: 'ペナン (Penan)', zh: '檳城', ko: '페낭' },
  'Kedah': { en: 'Kedah', ja: 'ケダ (Keda)', zh: '吉打', ko: '케다' },
  'Perlis': { en: 'Perlis', ja: 'ペルリス (Perurisu)', zh: '玻璃市', ko: '펄리스' },
  'Kelantan': { en: 'Kelantan', ja: 'クランタン (Kurantan)', zh: '吉蘭丹', ko: '클란탄' },
  'Terengganu': { en: 'Trengganu', ja: 'トレンガヌ (Torenganu)', zh: '丁加奴', ko: '트렝가누' },
};
