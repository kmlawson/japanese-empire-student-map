...
JMAP.TERRITORIES = {
  ...
  e1942: [
    ...
    // French ground with Japanese forces on it, which is what the stripes mean
    // elsewhere on this map. Japan did not take the administration over until
    // 9 March 1945, so drawing it as military occupation said that the thing
    // that happened in 1945 had happened in 1942.
    { id: 'indochina', atoms: ['indochina'], cat: 'french', lvl: 2, hatch: 'occupied',
      en: 'French Indochina', ja: '仏印 (Futsuin)', orig: 'Đông Dương thuộc Pháp',
      zh: '法屬印度支那', ko: '프랑스령 인도차이나 (P’ŭrangsŭryŏng Indoch’aina)',
      when: 'Japanese troops from September 1940; French administration to March 1945',
      note: 'Japanese troops entered the north in September 1940 and the south in July 1941 — the step that brought the American oil embargo. It is drawn in the French colour with Japanese stripes across it because that is what it was: Vichy French governors, courts, police and customs continued to run the colony, under a Japanese army that took what it wanted from it, until the coup of 9 March 1945 swept the French administration away in a night. Japanese rice requisition and the collapse of transport produced the Tonkin famine of 1944–45, in which perhaps a million people died.' },
