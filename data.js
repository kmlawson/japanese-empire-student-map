...
JMAP.TERRITORIES = {
  ...
  e1930: [
    ...
    { id: 'tibet', atoms: ['tibet'], cat: 'independent', lvl: 3,
    ...
    { id: 'goa', atoms: ['goa'], cat: 'portuguese', lvl: 3,
      en: 'Portuguese India (Goa)', ja: 'ポルトガル領インド (ゴア)', orig: 'Estado da Índia',
      zh: '葡屬印度（果阿）', ko: '포르투갈령 인도 (고아)',
      when: 'Portuguese from 1510',
      note: 'Goa, with Damão and Diu, was the seat of the Estado da Índia and the oldest European possession in Asia. It stayed Portuguese until India took it by force in 1961.' },
    { id: 'pondicherry', atoms: ['pondicherry'], cat: 'french', lvl: 3,
      en: 'French India (Pondicherry)', ja: 'フランス領インド (ポンディシェリ)', orig: 'Établissements français dans l’Inde',
      zh: '法屬印度（本地治里）', ko: '프랑스령 인도 (퐁디셰리)',
      when: 'French from 1674',
      note: 'Five scattered enclaves — Pondicherry, Karikal, Yanaon, Mahé and Chandernagore — left to France when Britain took the rest of India. Transferred to India in the 1950s.' },
    { id: 'hyderabad', atoms: ['hyderabad'], cat: 'british', c: '#a06f80', lvl: 3,
      en: 'Hyderabad State (approximate)', ja: 'ハイデラバード藩王国', orig: 'حیدر آباد',
      zh: '海得拉巴土邦', ko: '하이데라바드 번왕국',
      when: 'Princely state under the Nizam',
      note: 'The largest of the princely states: not British territory but a ruler in subsidiary alliance with the Crown, with its own army and currency. Drawn here from Telangana, its Telugu core; the Nizam’s dominions also took in Marathi and Kannada districts now in Maharashtra and Karnataka. It is the biggest reminder that "British India" on this map covers hundreds of such states.' },
    ...
    { id: 'tuva', atoms: ['tuva'], cat: 'soviet', c: '#a9b3c6', lvl: 3,
    ...
    { id: 'sikkim', atoms: ['sikkim'], cat: 'other', c: '#d9cfba', lvl: 3,
  ...
  e1942: [
    ...
    { id: 'goa', atoms: ['goa'], cat: 'neutral', lvl: 3,
      ...
      when: 'Portuguese from 1510',
      note: 'Goa, with Damão and Diu, was the seat of the Estado da Índia and the oldest European possession in Asia. It stayed Portuguese until India took it by force in 1961.' },
    { id: 'pondicherry', atoms: ['pondicherry'], cat: 'allied', lvl: 3,
      en: 'French India (Pondicherry)', ja: 'フランス領インド (ポンディシェリ)', orig: 'Établissements français dans l’Inde',
      zh: '法屬印度（本地治里）', ko: '프랑스령 인도 (퐁디셰리)',
      when: 'French from 1674',
      note: 'Five scattered enclaves — Pondicherry, Karikal, Yanaon, Mahé and Chandernagore — left to France when Britain took the rest of India. Transferred to India in the 1950s.' },
    { id: 'hyderabad', atoms: ['hyderabad'], cat: 'allied', c: '#8fa5bd', lvl: 3,
      en: 'Hyderabad State (approximate)', ja: 'ハイデラバード藩王国', orig: 'حیدر آباد',
      zh: '海得拉巴土邦', ko: '하이데라바드 번왕국',
      when: 'Princely state under the Nizam',
      note: 'The largest of the princely states: not British territory but a ruler in subsidiary alliance with the Crown, with its own army and currency. Drawn here from Telangana, its Telugu core; the Nizam’s dominions also took in Marathi and Kannada districts now in Maharashtra and Karnataka. It is the biggest reminder that "British India" on this map covers hundreds of such states.' },
    ...
    { id: 'mongolia', atoms: ['mongolia'], cat: 'neutral', c: '#b6b6a4', lvl: 2,
    ...
    { id: 'weihaiwei', atoms: ['weihaiwei'], cat: 'neutral', lvl: 3,
      en: 'Weihaiwei', ja: '威海衛 (Ikaiei)', orig: '威海衛 (Wēihǎiwèi)',
      zh: '威海衛', ko: '위해위 (Wihaewi)',
      when: 'Returned to China in 1930',
      note: 'A British leased territory from 1898 until October 1930. By this date it is Chinese again, and occupied by Japan with the rest of Shantung.' },
    { id: 'guangzhouwan', atoms: ['guangzhouwan'], cat: 'neutral', lvl: 3,
      en: 'Kwangchowan (Guangzhouwan)', ja: '広州湾 (Kōshūwan)', orig: 'Kouang-Tchéou-Wan',
      zh: '廣州灣', ko: '광주만 (Kwangjuman)',
      when: 'Leased to France 1898–1945',
    ...
    { id: 'tuva', atoms: ['tuva'], cat: 'neutral', c: '#b6b6a4', lvl: 3,
      en: 'Tannu Tuva (Tuvan People’s Republic)', ja: 'トゥヴァ人民共和国', orig: 'Тыва Арат Республик',
      zh: '唐努圖瓦', ko: '투바 인민공화국',
      when: 'Independent in name from 1921',
      note: 'Qing territory until 1911, then a Russian protectorate, then a nominally independent republic from 1921 — recognised only by the Soviet Union and Mongolia. Absorbed into the USSR in 1944. China went on claiming it.' },
