...
const look=p=>p.evaluate(()=>{
  ...
  return {
    ...
    stations: +((document.querySelector('#kf-stations .sta-pic-fill')||{getAttribute:()=>0}).getAttribute('data-total')),
    shown:+((document.querySelector('#kf-stations .sta-pic-fill')||{getAttribute:()=>0}).getAttribute('data-n')),
