...
const GROUPS = {
  ...
  transport: ['trains', 'stations', 'sugar', 'air', 'airplay'],
...
const SECS = { stations: 147, relief: 140, demography: 95, population: 71, 'layers-url': 70, names: 62, mapstrip: 56, trains: 54, japanpop: 44, theme: 40, labels: 40, subnames: 37, labelcats: 35, routes: 34, sugar: 33, twpop1930: 33, pin: 31, epoch: 29, mono: 27, colours: 26, extent: 26, islands: 25, manchupop: 25, keys: 24, legendpick: 22, labuan: 22, provsource: 19, bookmarks: 16, 'cache-keys': 15, backings: 15, taiwan: 15, korea: 14, zoom: 13, menu: 13, pointsize: 11, projclip: 11, taiwanpop: 7, air: 30, airplay: 32, clipping: 24,
