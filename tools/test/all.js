...
const MAP = ['taiwan', 'labels', 'provsource', 'backings', 'mapstrip',
             ...
             'labelcats', 'legendpick', 'subnames', 'japanpop', 'theme', 'twpop1930', 'manchupop'];
...
const SECS = { mapstrip: 45, run2: 41, labels: 32, run5: 35, run14: 32, run9: 30,
               ...
               population: 75, demography: 60, sugar: 40, epoch: 45, taiwanpop: 35, keys: 40, theme: 25, twpop1930: 40, manchupop: 40 };
